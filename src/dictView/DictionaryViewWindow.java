...
public class DictionaryViewWindow extends javax.swing.JFrame {
    ...
    private JMenuItem aboutMenuItem, exitMenuItem, gameItem;
    ...
    private void initComponents() {
        ...
        JScrollPane[] scroller ={meaningScroll,synoScroll,exScroll,synoScroll,antoScroll};
        ...
        gameItem.addActionListener(actionlisten);
    ...
    ActionListener actionlisten = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == aboutMenuItem) {
                ...
                msg = msg + "                                      ----DICTIONARY FOR CHILDREN----\n";
                msg = msg + "                                                   Copyright: BaoDoan\n";
                msg = msg + "------------------------------------------------------------------------\n";   
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DictionaryViewWindow().setVisible(true);
            }
        });
    }
